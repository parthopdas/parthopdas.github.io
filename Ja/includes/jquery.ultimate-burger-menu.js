...
(function($){
    ...
    $.fn.burgerMenu = function(options) {
        var settings = $.extend({
            ...
            menuBorder: '1px solid lightblue',
            linkColor: 'white',
            linkBackground: '#7F9861',
            linkPadding: '10px 10px',
            linkTextDecoration: 'none',
            linkBorderBottom: '1px solid lightblue',
        ...
        function createButton(eq){
            ...
            var $button = $('<div class="burger-menu-button burger-menu-button-' + eq + '"><span style="margin-left:-4.9em; color:#7F9861; opacity: 0.7;">Menu and Search</span><br></div>'),
            buttonCss = {
